...
if __name__ == "__main__":
    ...
    maths_subjects = process_data(maths, 'maths')
    trivia_subjects = process_data(trivia, 'trivia')
    puzzle_subjects = process_data(puzzles, 'puzzles')
    display_data(trivia_subjects)